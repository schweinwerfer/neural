...
public class TrainerTournament2 {
    private static final Logger LOG = Logger.getLogger(TrainerTournament2.class.getSimpleName());
    ...
    public TrainerTournament2() {
        rnd = new Random();
    }

    public static void main(String[] args) throws IOException {
        TrainerTournament2 tournament = new TrainerTournament2();
    ...
    private void start() throws IOException {
        ...
        while (isRunning) {
            ...
            Map<String, List<Coordinate>> movesToTrain = trainer.getMoves();
            for (PlayingAgent agent : population) {

                for (Map.Entry<String, List<Coordinate>> entry : movesToTrain.entrySet()) {
                    System.out.println("");
                }
            }
